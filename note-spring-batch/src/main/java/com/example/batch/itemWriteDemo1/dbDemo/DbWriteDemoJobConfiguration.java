...
//public class DbWriteDemoJobConfiguration {
//
//    @Autowired
...
//
//    @Autowired
//    @Qualifier("jdbcBatchItemWriterDemo")
//    private ItemWriter<UserInfo> jdbcBatchItemWriterDemo;
//
//    @Bean
//    public Job dbWriteDemoJob(){
//        return jobBuilderFactory.get("dbWriteDemoJob")
//                .start(dbWriteDemoStep())
//                .build();
//    }
//
//    @Bean
//    public Step dbWriteDemoStep(){
//        return stepBuilderFactory.get("dbWriteDemoStep")
//                .<UserInfo, UserInfo>chunk(100)
//                .reader(flatFileReaderDemo())
//                .writer(jdbcBatchItemWriterDemo)
//                .build();
//    }
//
//    @Bean
//    public FlatFileItemReader<UserInfo> flatFileReaderDemo(){
